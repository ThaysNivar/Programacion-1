...
determian el numero de letras minúsculas y mayúsculas que hay en el archivo. */

void minymay(FILE *);      /*Prototipo de función. */
/*Observa que esta función va a recibir un archivo como parametro. */
...
/*Esta función cuenta el numero de minusculas y mayusculas que hay en el
archivo arc. */
{
int min = 0, may = 0;
char p;
