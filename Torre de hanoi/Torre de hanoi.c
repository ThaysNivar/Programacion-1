...
void mueveDisco( int *tab, int fil, int col, int ultNum, int filOrig, int filDest )/* define la función mueveDisco, que se utiliza para mover un disco de una torre a otra.*/
{
    /*
    Precondición:
    *tab    Puntero a una matriz de tipo entero.
...
/*este es el punto de entrada del programa.*/
{
    ...
    /*Esta seccion define algunas variables utilizadas en el programa, como el numero de filas, columnas, el numero de discos, y el tamaño del tablero.*/
